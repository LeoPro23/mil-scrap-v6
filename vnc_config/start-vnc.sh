...
if [ -f /usr/share/novnc/utils/novnc_proxy ]; then
    /usr/share/novnc/utils/novnc_proxy --vnc 127.0.0.1:5900 --listen 0.0.0.0:6080 &
elif [ -f /usr/share/novnc/utils/launch.sh ]; then
    /usr/share/novnc/utils/launch.sh --vnc 127.0.0.1:5900 --listen 0.0.0.0:6080 &
else
...
echo "Puedes conectarte a VNC en: http://localhost:6080/vnc.html"
